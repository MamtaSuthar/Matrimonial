                                    ...
                                    <div class="col-lg-4 col-md-6 col-12 my-2">
                                        <div class="row shadow bg-white rounded-10 py-3 px-2 mx-0 h-100">
                                            <div class="form-group col-md-12 mb-0">
                                                ...
                                                <div class="custom-control custom-switch">
                                                    <input type="checkbox" class="custom-control-input selectallsettings" id="ui_settings-ui_settings" value="SettingsController@ui_settings" name="permissions[]">
                                                    <label class="custom-control-label fs-14 font-weight-normal" for="ui_settings-ui_settings">UI Settings</label>
                                                </div>
                                                
                                                <div class="custom-control custom-switch">
                                                    <input type="checkbox" class="custom-control-input selectallsettings" id="ui_settings-facebook_settings" value="SettingsController@facebook_settings" name="permissions[]">
                                                    <label class="custom-control-label fs-14 font-weight-normal" for="ui_settings-facebook_settings">Facebook Settings</label>
                                                </div>
                                                
                                                <div class="custom-control custom-switch">
                                                    <input type="checkbox" class="custom-control-input selectallsettings" id="ui_settings-google_settings" value="SettingsController@google_settings" name="permissions[]">
                                                    <label class="custom-control-label fs-14 font-weight-normal" for="ui_settings-google_settings">Google Settings</label>
                                                </div>
                                                
                                                <div class="custom-control custom-switch">
                                                    <input type="checkbox" class="custom-control-input selectallsettings" id="ui_settings-alert_settings" value="SettingsController@alert_settings" name="permissions[]">
                                                    <label class="custom-control-label fs-14 font-weight-normal" for="ui_settings-alert_settings">Alert Settings</label>
                                                </div>
                                                
                                                <div class="custom-control custom-switch">
                                                    <input type="checkbox" class="custom-control-input selectallsettings" id="ui_settings-payment_gateway_settings" value="SettingsController@payment_gateway_settings" name="permissions[]">
                                                ...
                                                <div class="custom-control custom-switch">
                                                    <input type="checkbox" class="custom-control-input selectallsettings" id="ui_settings-reset_admin_theme" value="SettingsController@reset_admin_theme" name="permissions[]">
                                    ...
                                    <div class="col-lg-4 col-md-6 col-12 my-2">
                                        <div class="row shadow bg-white rounded-10 py-3 px-2 mx-0 h-100">
                                            <div class="form-group col-md-12 mb-0">
                                                ...
                                                <div class="custom-control custom-switch">
                                                    <input type="checkbox" class="custom-control-input selectallseries" id="series-index" value="SeriesController@index,SeriesController@series_datatable" name="permissions[]">
                                    ...
                                    <div class="col-lg-4 col-md-6 col-12 my-2">
                                        <div class="row shadow bg-white rounded-10 py-3 px-2 mx-0 h-100">
                                            <div class="form-group col-md-12 mb-0">
                                                ...
                                                <div class="custom-control custom-switch">
                                                    <input type="checkbox" class="custom-control-input selectallrec_fund" id="selectallrec_fund-card" value="FundController@card,FundController@cardtable" name="permissions[]">
                                    ...
                                    <div class="col-lg-4 col-md-6 col-12 my-2">
                                        <div class="row shadow bg-white rounded-10 py-3 px-2 mx-0 h-100">
                                            <div class="form-group col-md-12 mb-0">
                                                ...
                                                <div class="custom-control custom-switch">
                                                    <input type="checkbox" class="custom-control-input selectallnotification" id="selectallnotification-smsnotifications" value="NotificationController@smsnotifications, NotificationController@getusers,NotificationController@addmodule,NotificationController@import" name="permissions[]">
                                    ...
                                    <div class="col-lg-4 col-md-6 col-12 my-2">
                                        <div class="row shadow bg-white rounded-10 py-3 px-2 mx-0 h-100">
                                            <div class="form-group col-md-12 mb-0">
                                                ...
                                                <div class="custom-control custom-switch">
                                                    <input type="checkbox" class="custom-control-input selectallccontest" id="selectallccontest-create_custom" value="ContestController@create_custom" name="permissions[]">
                                    ...
                                    <div class="col-lg-4 col-md-6 col-12 my-2">
                                        <div class="row shadow bg-white rounded-10 py-3 px-2 mx-0 h-100">
                                            <div class="form-group col-md-12 mb-0">
                                                ...
                                                <div class="custom-control custom-switch">
                                                    <input type="checkbox" class="custom-control-input selectallresultcontroller" id="selectallresultcontroller-updatepoints" value="ResultController@updatepoints,ResultController@batting_points,ResultController@bowling_points,ResultController@fielding_points,ResultController@team_points,ResultController@match_score,ResultController@select_join_person" name="permissions[]">
                                                ...
                                                <div class="custom-control custom-switch">
                                                    <input type="checkbox" class="custom-control-input selectallresultcontroller" id="selectallresultcontroller-match_points" value="ResultController@match_points,ResultController@viewwinners,ResultController@distribute_winning_amount" name="permissions[]">
                                    ...
                                    <div class="col-lg-4 col-md-6 col-12 my-2">
                                        <div class="row shadow bg-white rounded-10 py-3 px-2 mx-0 h-100">
                                            <div class="form-group col-md-12 mb-0">
                                                ...
                                                <div class="custom-control custom-switch">
                                                    <input type="checkbox" class="custom-control-input selectallpointsystem" id="selectallpointsystem-point_system" value="PointSystemController@point_system" name="permissions[]">
                                                    <label class="custom-control-label fs-14 font-weight-normal" for="selectallpointsystem-point_system">View Point System</label>
                                                </div>
                                                
                                                <div class="custom-control custom-switch">
                                                    <input type="checkbox" class="custom-control-input selectallpointsystem" id="selectallpointsystem-update_point_system" value="PointSystemController@update_point_system" name="permissions[]">
