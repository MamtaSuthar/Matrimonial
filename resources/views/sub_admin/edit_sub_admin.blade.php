                                    ...
                                    <div class="col-lg-4 col-md-6 col-12 my-2">
                                        <div class="row shadow bg-white rounded-10 py-3 px-2 mx-0 h-100">
                                            <div class="form-group col-md-12 mb-0">
                                                ...
                                                <div class="custom-control custom-switch">
                                                    <input type="checkbox" class="custom-control-input selectallseries" id="series-index" @if( in_array("SeriesController@index" ,$permissions ) ) checked @endif value="SeriesController@index,SeriesController@series_datatable" name="permissions[]">
                                    ...
                                    <div class="col-lg-4 col-md-6 col-12 my-2">
                                        <div class="row shadow bg-white rounded-10 py-3 px-2 mx-0 h-100">
                                            <div class="form-group col-md-12 mb-0">
                                                ...
                                                <div class="custom-control custom-switch">
                                                    <input type="checkbox" class="custom-control-input selectallupc_match" id="upc_match-playerroles" @if( in_array("MatchController@playerroles" ,$permissions ) ) checked @endif value="MatchController@playerroles,MatchController@viewmatchdetails,MatchController@launchmatch,MatchController@updatelogo,MatchController@importdatafromapi,MatchController@launch,MatchController@deleteplayer,MatchController@DownloadPlayer,MatchController@DownloadPlayer2,MatchController@UploadPlayer,MatchController@UploadPlayer2" name="permissions[]">
                                    ...
                                    <div class="col-lg-4 col-md-6 col-12 my-2">
                                        <div class="row shadow bg-white rounded-10 py-3 px-2 mx-0 h-100">
                                            <div class="form-group col-md-12 mb-0">
                                                ...
                                                <div class="custom-control custom-switch">
                                                    <input type="checkbox" class="custom-control-input selectallccontest" id="selectallccontest-create_custom" @if( in_array("ContestController@create_custom" ,$permissions ) ) checked @endif value="ContestController@create_custom" name="permissions[]">
