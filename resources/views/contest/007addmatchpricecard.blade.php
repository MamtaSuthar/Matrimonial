                    ...
                    <div class="sbp-preview">
                        <div class="sbp-preview-content">
                            ...
                            <div class="row">
                                ...
                                <?php if ($findchallenge1->pricecard_type == 'Amount') { ?>
                                <div class="col-md-4">
                                    <div class="form-group">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        {{ Form::number('price_percent', null, ['value' => '', 'required' => '', 'placeholder' => 'Price Amount In Percentage ', 'min' => '1', 'autocomplete' => 'off', 'class' => 'form-control form-control-solid']) }}
                                    </div>
                                </div>
                                <?php } ?>
                            </div>
