            ...
            <div class="sbp-preview">
                <div class="sbp-preview-content p-2">
                    <div class="row mx-0 align-items-end">
                        ...
                        <!-- <a  href="<?php echo action('ContestController@privatecontest', $_GET) ?>" class="btn btn-sm btn-sm text-uppercase font-weight-bold mx-2 btn-success _m_btn"  style="float:right;padding-bottom: 5px;margin-top: 25px;"><i class="fa fa-plus"></i>&nbsp; Add Private Contests</a> -->
                        </div>
                    </div>
                </div>
            </div>
