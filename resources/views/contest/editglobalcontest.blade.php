                    ...
                    <div class="row mx-0">
                        ...
                        <div class="col-12 mt-3" id="team_limit" style="display:none">
                            <div class="form-group">
                                ...
                                <input disabled="" id="ch21" type="number" class="form-control form-control-solid"  name="team_limit" value="{{$challenge->team_limit}}" placeholder="Enter Team Limit" required="">
                            </div>
                        </div>
                        <div class="col-md-3">
