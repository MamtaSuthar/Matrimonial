                           ...
                           <div class="col">
                               <div class="row">
                                   ...
                                   <div class="col-12 text-center">
                                        <?php if($fmatch->team1logo != ""){?>
                                            <img src="<?php echo URL::asset('public/'.$fmatch->team1logo)?>" class="w-40px view_team_table_images2 h-40px rounded-pill" onerror="this.src='<?php echo URL::asset('public/team_image.png')?>'">
                                        <?php }else{?>
                               ...
                               <div class="row">
                                   ...
                                   <div class="col-12 text-center">
                                        <?php if($fmatch->team2logo != "") {?>
                                            <img src="<?php echo URL::asset('public/'.$fmatch->team2logo)?>" class="w-40px view_team_table_images2 h-40px rounded-pill" onerror="this.src='<?php echo URL::asset('public/team_image.png')?>'">
                                        <?php }else{ ?>
                                            <img src="<?php echo URL::asset('public/team_image.png')?>" class="w-40px view_team_table_images2 h-40px rounded-pill">
                                        <?php }?>
                                   </div>
