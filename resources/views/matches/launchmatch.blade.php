                                ...
                                <div class="row justify-content-center">
                                    <div class="col-auto">
                                        @if($findmatchdetails->team1logo!="")
                                            <img src="{{ URL::asset('public/'.$findmatchdetails->team1logo) }}" class="w-100px h-100px rounded-pill shadow" onerror="this.src='{{ URL::asset('public/team_image.png') }}'">
                                ...
                                <div class="row justify-content-center">
                                    <div class="col-auto">
                                        @if($findmatchdetails->team2logo!="")
                                            <img src="{{ URL::asset('public/'.$findmatchdetails->team2logo) }}" class="w-100px h-100px rounded-pill shadow" onerror="this.src='{{ URL::asset('public/team_image.png') }}'">
                                                                                ...
                                                                                <div class="avatar-preview w-100px h-100px position-relative rounded-pill shadow">
                                                                                    ...
                                                                                    <?php
                                                                                        ...
                                                                                        if( @GetImageSize( asset('public/'. $image) ) ){
                                                                                            ...
                                                                                            $img = asset('public/player_image.png');
                                                                                        }
                                                                                    ?>
