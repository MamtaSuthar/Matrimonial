                    ...
                    <div class="col-xl-5 col-lg-6 col-md-8 col-sm-11">
                        <div class="card mt-5 mb-3">
                            ...
                            <div class="card-body p-4">
                                {{-- {{ Form::open(array('method' =>'post', 'action' => action('HomeController@admin_change_password2'),'files' => true,'id' => 'j-forms','class'=>'j-forms')) }} --}}
                                <form action="{{route('admin_paas')}}" method="post" >
                            {{csrf_field()}}
                            <div class="">
                        ...
                        <div class="card my-0 bg-transparent shadow-none border-0">
                            <div class="card-body p-3 text-center bg-transparent">
                                <a href="{{ asset('my-admin/register')}}" class="btn shadow-none"><i class="fad fa-long-arrow-alt-left"></i>&nbsp;&nbsp;&nbsp; Return to Dashboard </a>
                            </div>
                        </div>
                    </div>
                </div>
