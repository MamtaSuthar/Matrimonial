                ...
                <?php
                 ...
                 ?>
                  <tr>
                    ...
                    @if($data->joinedusers)
                        <td><a href=" {{ action('ContestFullDetailController@allusers',[$data->id,$matchkey])}}"  class="btn btn-sm btn-primary w-35px h-35px"  data-toggle="tooltip" title="View Users"><i class="fas fa-eye"></i></a></td>
                    @else
                        <td></td>
                    @endif
                    </tr>
