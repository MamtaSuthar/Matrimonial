        ...
        //Searching for Banner Show
            ...
            if (!empty($posts)) {
                ...
                foreach ($posts as $post) {
                  ...
                  $nestedData['image'] =  '<a href="'.asset('public/popup_notify/'.$post->image).'" target="_blank"><img src="'.asset('public/popup_notify/'.$post->image).'" style="heigh:90px; width:100px;" onerror="'.$default_img.'"></a>';   
