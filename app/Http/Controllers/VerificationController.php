...
class VerificationController extends Controller
{
    ...
    public function updatepantatus(Request $request)
    {
        ...
        if ($status == 1) {
            ...
            $datamessage['subject'] = 'your PAN Card Request has been successfully Approved';
            ...
            $st = 'rejected';
            $datamessage['email'] = $finduserbonus->email;
            $datamessage['subject'] = 'Sorry, your PAN Card Documents were not Approved';
    ...
    public function updatebanktatus(Request $request)
    {
        if ($request->isMethod('post')) {
            ...
            if ($status == 2) {
                $st = 'rejected';
                $datamessage['email'] = $finduserbonus->email;
                $datamessage['subject'] = 'Sorry, your Bank Documents were not Approved';
                $datamessage['content'] = '<p><strong>Hello ' . ucwords($finduserbonus->team) . ' </strong></p>';
            ...
            if (!empty($input['approve'])) {
                if ($input['approve'] == 'Approve') {
                    ...
                    //===============================Cashfree Payout work =============================================================
                      ...
                      // } else {
                      //   return Redirect::back()->with('danger', 'Insufficient amount in cashfree.');
                      // }
                    // =================================================================================================
