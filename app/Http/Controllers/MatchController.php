    ...
    public function importsquad($matchid)
    {
        ...
        if (!empty($getdetails)) {
            ...
            if (empty($findteam1)) {
                ...
                $mpdata['short_name'] = $getdetails['data']['card']['teams']['a']['name'] ?? $team1key;
                $team1id = DB::connection('mysql2')->table('teams')->insertGetId($mpdata);
            } else {
                $team1id = $findteam1->id;
				if ($findteam1->short_name == $team1key) {
					$team_data1['short_name'] = $getdetails['data']['card']['teams']['a']['short_name'] ?? $team1key;
					DB::connection('mysql2')->table('teams')->where('id', '=', $findteam1->id)->update($team_data1);
				}
            }
            ...
            if (empty($findteam2)) {
                ...
                $mpdata1['short_name'] = $getdetails['data']['card']['teams']['b']['name'] ?? $team2key;
                $team2id = DB::connection('mysql2')->table('teams')->insertGetId($mpdata1);
            } else {
                $team2id = $findteam2->id;
				if ($findteam2->short_name == $team2key) {
					$team_data2['short_name'] = $getdetails['data']['card']['teams']['b']['short_name'] ?? $team2key;
					DB::connection('mysql2')->table('teams')->where('id', '=', $findteam2->id)->update($team_data2);
				}
            }
            $matchadata['team1'] = $team1id;
                    ...
                    if (!empty($team1players)) {
                        foreach ($team1players as $players1) {
                            ...
                            if (!empty($findmatchexist)) {
                                ...
                                // dump('team------1',((!empty($pkey)) && ($pkey != '' || $pkey == 0)));continue;
                                $data['credit'] = ((!empty($pkey)) && ($pkey != '' || $pkey == 0)) ? $playerscredit['data']['fantasy_points'][$pkey]['credit_value'] : 9;
                                if (empty($findplayerexist)) {
                                    ...
                                    $credit = ((!empty($pkey)) && ($pkey != '' || $pkey == 0)) ? $playerscredit['data']['fantasy_points'][$pkey]['credit_value'] : 9;
                                } else {
                                    $playerid = $findplayerexist->id;
                                    $credit = ((!empty($pkey)) && ($pkey != '' || $pkey == 0)) ? $playerscredit['data']['fantasy_points'][$pkey]['credit_value'] : $findplayerexist->credit;
                    ...
                    if (!empty($team2players)) {
                        foreach ($team2players as $players2) {
                            ...
                            if (!empty($findmatchexist)) {
                                ...
                                // dump((!empty($pkey1)) || $pkey1 != '' || $pkey1 == 0);continue;
                                $data['credit'] = ((!empty($pkey)) && ($pkey != '' || $pkey == 0)) ? $playerscredit['data']['fantasy_points'][$pkey1]['credit_value'] : 9;
                                if (empty($findplayer2exist)) {
                                    ...
                                    $playerid = DB::connection('mysql2')->table('players')->insertGetId($data);
                                    $credit = ((!empty($pkey)) && ($pkey != '' || $pkey == 0)) ? $playerscredit['data']['fantasy_points'][$pkey1]['credit_value'] : 9;
                                } else {
                                    $playerid = $findplayer2exist->id;
                                    $credit = ((!empty($pkey)) && ($pkey != '' || $pkey == 0)) ? $playerscredit['data']['fantasy_points'][$pkey1]['credit_value'] : $findplayer2exist->credit;
