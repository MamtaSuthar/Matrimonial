                                        ...
                                        <table width="100%" cellspacing="0" cellpadding="0" style="margin:0;padding:0">
                                            <tbody><tr style="margin:0;padding:0">
                                                <td valign="top" align="center" width="100" style="margin:0;padding:0">
                                                    <img alt="'.(Helpers::settings()->project_name ?? '').'" style="width:40px;padding:0;max-width:100%; padding: 5px;" src="'.(Helpers::settings()->site_url ?? '').'/'.(Helpers::settings()->admin_folder ?? '').'/public/logo.png" class="CToWUd">
                                                </td>
                                            </tr>
                                        </tbody></table>
                                    </td>
                                                            ...
                                                            <tr style="margin:0;padding:0">
                                                                ...
                                                                <td class="m_-7802618208648170374icon" style="margin:0;padding:0;padding-right:5px">
                                                                    <a  style="margin:0;padding:0;color:#2ba6cb;display:block" target="_blank" >
                                                                        <img style="height:15px;width:auto;margin:0;padding:0;max-width:100%;max-height:15px!important" src="'.(Helpers::settings()->site_url ?? '').'/'.(Helpers::settings()->admin_folder ?? '').'/public/logo.png" class="CToWUd">
                                                                    </a>
                                                                </td>
                                                            </tr>
                                                        </tbody>
                                                            ...
                                                            <tr style="margin:0;padding:0">
                                                                ...
                                                                <td class="m_-7802618208648170374icon" style="margin:0;padding:0;padding-right:5px">
                                                                    <a href="https://www.facebook.com/" style="margin:0;padding:0;color:#2ba6cb;display:block" target="_blank" >
                                                                        <img style="height:15px;width:auto;margin:0;padding:0;max-width:100%;max-height:15px!important" src="'.(Helpers::settings()->site_url ?? '').'/'.(Helpers::settings()->admin_folder ?? '').'/public/fb.png" alt="Facebook" border="0" class="CToWUd"></a>
                                                                </td>
                                                                <td class="m_-7802618208648170374icon" style="margin:0;padding:0;padding-right:5px">
                                                                    <a href="https://twitter.com" style="margin:0;padding:0;color:#2ba6cb;display:block" target="_blank">
                                                                        <img style="height:15px;width:auto;margin:0;padding:0;max-width:100%;max-height:15px!important" src="'.(Helpers::settings()->site_url ?? '').'/'.(Helpers::settings()->admin_folder ?? '').'/public/tw.png" alt="Twitter" border="0" class="CToWUd"></a>
                                                                </td>
                                                            </tr>
                                                        </tbody>
                                                    </table>
